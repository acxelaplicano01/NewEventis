...
<style>
    ...
    .fc .fc-scrollgrid, .fc .fc-col-header-cell, .fc .fc-daygrid-day {
        border-color: rgba(147, 160, 179, 0.15) !important; /* slate-500 con opacidad baja */
    }
    ...
    .dark .fc .fc-button:hover, .dark .fc .fc-button-active {
        background-color: #facc15;
        color: #1c1917;
    }
