...
>
    ...
    <div class="relative">
        <input
            ...
            type="text"
            id="{{ $id }}"
            {{ $attributes->merge(['class' => 'w-full rounded-md border-stone-300 dark:border-stone-700 dark:bg-stone-900 dark:text-stone-300 focus:border-yellow-500 dark:focus:border-stone-600 focus:ring-yellow-500 dark:focus:ring-stone-600 shadow-sm py-2 pl-3 pr-10']) }}
    ...
    >
        ...
        <div class="bg-stone-50 dark:bg-stone-700 px-4 py-2 flex justify-between">
            <button 
                ...
                @click.stop 
                class="text-sm text-yellow-600 dark:text-stone-400 hover:text-yellow-800 dark:hover:text-stone-300 font-medium"
            >
                Hoy
            </button>
            <button 
