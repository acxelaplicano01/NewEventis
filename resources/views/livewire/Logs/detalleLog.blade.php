<x-app-layout>
    <div>
        <div class=" mx-auto rounded-lg mt-8 sm:mt-6 lg:mt-4 mb-6">
            <div class="overflow-hidden bg-white shadow sm:rounded-lg dark:bg-stone-900">
                ...
                <div class="border border-gray-200 dark:border-stone-700">
                    <dl>
                        <div class="px-4 py-5 bg-gray-50 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-stone-800">
                        ...
                        <div class="px-4 py-5 bg-white sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-stone-700">
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-300">
                                Dirección IP
                            </dt>
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 dark:text-white">
                        ...
                        <div class="px-4 py-5 bg-white sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-stone-700">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 dark:text-white">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-sm font-medium bg-gray-100 text-gray-800 dark:bg-stone-700 dark:text-gray-300">
                        ...
                        <div class="px-4 py-5 bg-white sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6 dark:bg-stone-700">
                            ...
                            <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2 dark:text-white">
                                @if(!empty($log->data))
                                    <div class="p-4 overflow-auto bg-gray-100 rounded-md max-h-96 dark:bg-stone-900">
