    ...
    <div class="mt-6 p-4 bg-white rounded-lg shadow sm:p-6 dark:bg-stone-900">
        ...
        <div class="mt-5">
            <div class="flex items-end gap-4">
                <div>
                    <label for="days" class="block text-sm font-medium text-stone-700 dark:text-stone-300">
                    ...
                    <div class="mt-1">
                        <x-input 
                            ...
                            wire:model="days" 
                            id="days" 
                            class="block w-24 border-gray-300 rounded-md shadow-sm focus:border-yellow-500 focus:ring-yellow-500 dark:bg-stone-700 dark:border-stone-600"
                        />
                    </div>
                    @error('days') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div class="pb-px">
                    <span class="text-stone-700 dark:text-stone-300">días</span>
                </div>
                <div>
