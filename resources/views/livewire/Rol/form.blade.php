<div class="mx-auto rounded-lg mt-8 sm:mt-6 lg:mt-4 mb-6">
    ...
    <div class="bg-white dark:bg-stone-800 overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <form id="roleForm" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-input wire:model="name" type="text" name="name"
                            class="form-input block w-full rounded-md border-stone-300 dark:border-stone-700 dark:bg-stone-900 dark:text-white"
                ...
                <div class="border-t border-stone-200 dark:border-stone-700 pt-6">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            <h3 class="text-lg font-medium text-stone-900 dark:text-white">Permisos del Rol</h3>
                    ...
                    <div class="border border-stone-200 dark:border-stone-700 rounded-lg p-4 bg-stone-50 dark:bg-stone-900">
                        @php
                                        ...
                                        <div class="flex items-center justify-between mb-3">
                                            <div class="flex items-center">
                                                ...
                                                @else
                                                    ...
                                                    <span class="ms-3 text-base font-semibold text-stone-800 dark:text-stone-200">
                                            ...
                                            @if(count($parentData['children']) > 0)
                                                <button @click="open = !open" type="button"
                                                    class="flex items-center text-sm text-stone-500 dark:text-stone-400 hover:text-stone-700 dark:hover:text-stone-300">
                                        ...
                                        <div x-show="open" class="ml-6 space-y-3">
                                            @foreach($parentData['children'] as $child)
                                                @if(count($child['children']) > 0)
                                                    ...
                                                    <div x-data="{ childOpen: true }" class="border-l-2 border-stone-200 dark:border-stone-600 pl-4">
                                                        <div class="flex items-center justify-between mb-2">
                                                            ...
                                                            <button @click="childOpen = !childOpen" type="button"
                                                                class="flex items-center text-xs text-stone-400 dark:text-stone-500 hover:text-stone-600 dark:hover:text-stone-300">
                                                ...
                                                @else
                                                    ...
                                                    <div class="border-l-2 border-stone-200 dark:border-stone-600 pl-4">
                                                        <x-toggle wire:model="selectedPermissions" name="selectedPermissions[]"
                                                            value="{{ $child['id'] }}">
                                                            {{ $child['display'] }}
                                                        </x-toggle>
                        ...
                        @if(count($standalonePermissions) > 0)
                            <div class="mt-6 pt-6 border-t border-stone-200 dark:border-stone-700">
                                <h4 class="text-sm font-medium text-stone-700 dark:text-stone-300 mb-3">Otros permisos</h4>
        ...
        <!-- Footer fijo -->
        <div class="sticky bottom-0 bg-white dark:bg-stone-800 px-6 py-4 border-t border-stone-200 dark:border-stone-700">
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4">
