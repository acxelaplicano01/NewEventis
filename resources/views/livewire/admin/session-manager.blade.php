                                    ...
                                    @if ($session->user_id)
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 mr-3">
                                                <div
                                                    class="h-8 w-8 rounded-lg bg-yellow-400 text-stone-900 flex items-center justify-center">
                                                    <span
                                    ...
                                    <div class="flex justify-end space-x-2">
                                        ...
                                        @if($session->user_id && !$session->is_current_device)
                                            <button wire:click="terminateAllUserSessions({{ $session->user_id }})"
                                                ...
                                                <svg class="w-6 h-6 text-yellow-400 hover:text-yellow-500 dark:text-yellow-400 dark:hover:text-yellow-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                                                    height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <div
                                ...
                                @if($session->user_id)
                                    <div class="flex items-center mb-2">
                                        <div
                                            class="h-8 w-8 rounded-full bg-yellow-400 text-stone-900flex items-center justify-center mr-2">
                                            <span
                                                class="text-white text-xs font-bold">{{ substr($session->name ?? 'CX', 0, 2) }}</span>
                                        </div>
                                        <div>
