<x-dialog-modal wire:model="isOpen" maxWidth="2xl">
    ...
    <x-slot name="content">
        <form wire:submit.prevent="store">
            <div class="mb-4">
                <label for="nombreevento" class="block text-stone-700 text-sm font-bold mb-2 dark:text-white">Nombre del
                    Evento:</label>
                <input type="text"
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="mb-4">
                    <label for="fechainicio" class="block text-stone-700 text-sm font-bold mb-2 dark:text-white">Fecha
                        Inicio:</label>
                    <input type="date"
                        class="shadow bg-stone-50 border border-stone-300 text-stone-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-stone-700 dark:border-stone-600 dark:placeholder-stone-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500"
                ...
                <div class="mb-4">
                    <label for="fechafinal" class="block text-stone-700 text-sm font-bold mb-2 dark:text-white">Fecha
                        Fin:</label>
                    <input type="date"
                        class="shadow bg-stone-50 border border-stone-300 text-stone-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-stone-700 dark:border-stone-600 dark:placeholder-stone-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500"
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                <div class="mb-4">
                    <label for="horainicio" class="block text-stone-700 text-sm font-bold mb-2 dark:text-white">Hora
                        Inicio:</label>
                    <input type="time"
                        class="shadow bg-stone-50 border border-stone-300 text-stone-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-stone-700 dark:border-stone-600 dark:placeholder-stone-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500"
                ...
                <div class="mb-4">
                    <label for="horafin" class="block text-stone-700 text-sm font-bold mb-2 dark:text-white">Hora
                        Fin:</label>
                    <input type="time"
                        class="shadow bg-stone-50 border border-stone-300 text-stone-900 text-sm rounded-lg focus:ring-yellow-500 focus:border-yellow-500 block w-full p-2.5 dark:bg-stone-700 dark:border-stone-600 dark:placeholder-stone-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500"
            ...
            <div class="grid grid-cols-2 gap-4 mt-4">
                ...
                <div class="mb-4">
                    <label for="diplomasSelect"
                        class="block text-stone-700 text-sm font-bold mb-2 dark:text-white">Plantilla del
                        diploma:</label>
